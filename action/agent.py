...
class ActionAgent:
    def __init__(self, config: SpacecraftConfig,
        ...
        # Raw, un-trimmed evaluate_all_actions() output (full per-horizon
        # trajectories included). _format_payload() strips these out before
        # publishing to Redis since raw Monte-Carlo trajectory arrays are far
        # too large for the wire message; local consumers that need the full
        # data (e.g. CounterfactualVisualizer) should read this instead.
